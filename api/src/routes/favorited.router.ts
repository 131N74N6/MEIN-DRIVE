...
import { addToFavorite, deleteAllFavoriteFiles, deleteFavoriteFile, getCurrentUserFavorite, isInFavorite } from '../controllers/favorited.controller';
...
favoriteRoutes.get('/is-favorite', verifyToken, isInFavorite);
